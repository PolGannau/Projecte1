...
void Enemy_WhiteTurret::Move() 
{
	if (up) {
		...
		if (angle > -200 && angle <= -160) { //1
			...
			if (Shoot == true && b < 200) {
				App->particles->AddParticle(App->particles->TurretShot, position.x + 12, position.y + 3, COLLIDER_ENEMY_SHOT);
				Shoot = false;
			}
		}
			...
			if (Shoot == true && b < 200) {
				App->particles->AddParticle(App->particles->TurretShot, position.x + 9, position.y, COLLIDER_ENEMY_SHOT);
				Shoot = false;
			}
		}
			...
			if (Shoot == true && b < 200) {
				App->particles->AddParticle(App->particles->TurretShot, position.x + 6, position.y, COLLIDER_ENEMY_SHOT);
				Shoot = false;
			}
		}
			...
			if (Shoot == true && b < 200) {
				App->particles->AddParticle(App->particles->TurretShot, position.x + 3, position.y - 1, COLLIDER_ENEMY_SHOT);
				Shoot = false;
			}
		}
			...
			if (Shoot == true && b < 200) {
				App->particles->AddParticle(App->particles->TurretShot, position.x + 3, position.y, COLLIDER_ENEMY_SHOT);
				Shoot = false;
			}
		}
			...
			if (Shoot == true && b < 200) {
				App->particles->AddParticle(App->particles->TurretShot, position.x - 1, position.y, COLLIDER_ENEMY_SHOT);
				Shoot = false;
			}
		}
			...
			if (Shoot == true && b < 200) {
				App->particles->AddParticle(App->particles->TurretShot, position.x - 3, position.y + 3, COLLIDER_ENEMY_SHOT);
				Shoot = false;
			}
		}
	}
		...
		if (angle > -20 && angle <= 20) { // 1
			...
			if (Shoot == true && b < 200) {
				App->particles->AddParticle(App->particles->TurretShot, position.x - 3, position.y + 6, COLLIDER_ENEMY_SHOT);
				Shoot = false;
			}
		}
			...
			if (Shoot == true && b < 200) {
				App->particles->AddParticle(App->particles->TurretShot, position.x - 2, position.y + 10, COLLIDER_ENEMY_SHOT);
				Shoot = false;
			}
		}
			...
			if (Shoot == true && b < 200) {
				App->particles->AddParticle(App->particles->TurretShot, position.x - 1, position.y + 12, COLLIDER_ENEMY_SHOT);
				Shoot = false;
			}
		}
			...
			if (Shoot == true && b < 200) {
				App->particles->AddParticle(App->particles->TurretShot, position.x + 3, position.y + 12, COLLIDER_ENEMY_SHOT);
				Shoot = false;
			}
		}
			...
			if (Shoot == true && b < 200) {
				App->particles->AddParticle(App->particles->TurretShot, position.x + 3, position.y + 16, COLLIDER_ENEMY_SHOT);
				Shoot = false;
			}
		}
			...
			if (Shoot == true && b < 200) {
				App->particles->AddParticle(App->particles->TurretShot, position.x + 6, position.y + 12, COLLIDER_ENEMY_SHOT);
				Shoot = false;
			}
		}
			...
			if (Shoot == true && b < 200) {
				App->particles->AddParticle(App->particles->TurretShot, position.x + 9, position.y + 12, COLLIDER_ENEMY_SHOT);
				Shoot = false;
			}
		}
			...
			if (Shoot == true && b < 200) {
				App->particles->AddParticle(App->particles->TurretShot, position.x + 9, position.y + 10, COLLIDER_ENEMY_SHOT);
				Shoot = false;
			}
		}
		else {
			...
			if (Shoot == true && b < 200) { // 9
				App->particles->AddParticle(App->particles->TurretShot, position.x + 12, position.y + 6, COLLIDER_ENEMY_SHOT);
				Shoot = false;
			}
		}
	}
