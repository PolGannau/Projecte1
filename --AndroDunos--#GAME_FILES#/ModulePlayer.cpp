...
=======
		App->enemies->AddEnemy(ENEMY_TYPES::SHIPUPDOWN, position.x + 250, position.y,true, 1); // si poses 2 es posara el 2 del small
>>>>>>> f4c61be427a8e8542deaaf70c92300f780a9dc76
